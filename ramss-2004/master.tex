...
\newcommand{\aumail}[1]{\small{\mailto{#1}}}
\newcommand{\aupar}[0]{\end{tabular} \\ \begin{tabular}[t]{c}}
...
button links to the project web site for more information.  This
...
running. It provides a simple popup menu with a toggle to globally
...
We transmit reports using HTTP POST requests across an encrypted SSL
