...
/* 				 G_CALLBACK (rb_library_source_drop_cb), source, 0); */
...
/* 	g_signal_connect_object (G_OBJECT (source->priv->albums), "drag_data_received", */
/* 				 G_CALLBACK (rb_library_source_drop_cb), source, 0); */
...
/* 	g_signal_connect_object (G_OBJECT (source->priv->artists), "drag_data_received", */
/* 				 G_CALLBACK (rb_library_source_drop_cb), source, 0); */
