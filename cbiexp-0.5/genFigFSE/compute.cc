...
int main(int argc, char** argv)
{
    ...
    for (i = 1; i < argc; i++) {
        ...
        if (strcmp(argv[i], "-h") == 0) {
            printf("Usage: compute -s runs_file -f runs_file -d 1|10|100|1000\n");
            return 0;
        }
    ...
    for (i = 0; i < NUM_RUNS; i++) {
        ...
        switch (ds) {
        case 1   : sprintf(file, "/moa/sc4/mhn/ds1/%d.txt"   , i); break;
        case 10  : sprintf(file, "/moa/sc4/mhn/ds10/%d.txt"  , i); break;
        case 100 : sprintf(file, "/moa/sc4/mhn/ds100/%d.txt" , i); break;
        case 1000: sprintf(file, "/moa/sc4/mhn/ds1000/%d.txt", i); break;
        }
