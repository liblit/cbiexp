...
\issue[Alice]{The notation 'P v not P' confuses P with R(P).  We've
  ...
  changed this to the conditional probability notation.  But we should 
  still deal with this issue in subsequent texts.}
\issue[Alice]{I've modified the sentence ``In any given run...'' to make
  it less of a run-on sentence.}
%%
