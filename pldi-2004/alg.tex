...
sequence of bands.  The black band on the left shows the context
score.  The dark gray band (\textseg{red}) shows the lower bound of
the increase score with 95\% confidence.  The light gray band
(\textseg{pink}) shows the size of that confidence interval.  It is
either not visible or very small in most thermometers, indicating a
tight interval.  The white space at the right end of the thermometer
shows the successful runs in which the predicate was observed to be
