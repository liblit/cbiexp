...
power.  For our algorithm, we can safely discard all such predicates.
We will discuss possible exceptions to this case in Section~\ref{sec:extensions}.
...
also useful to assess statistical significance of $\importance$ scores
...
we can use the delta method (see, e.g., \cite{Lehmann:2003:theory}) to derive 
approximate confidence intervals.  Computing the means and variances 
