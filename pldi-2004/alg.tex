...
Finally, we studied an optimization in which we eliminated redundant
...
However, we obtained nearly identical experimental results with and without 
this optimization, indicating that it was unnecessary. 
