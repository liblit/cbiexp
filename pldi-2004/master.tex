...
\usepackage[bookmarks,pdfauthor={Ben Liblit, Mayur Naik, Alice
  X. Zheng, Alex Aiken, and Michael
  I. Jordan}pdfpagemode=UseOutlines]{hyperref}
\usepackage{nicefrac}
\usepackage{xspace}
...
\bibliography{cacm1990,icse02,icse03,misc,paste02,pods,ramss,refs}
