...
\documentclass[preprint,final]{sigplanconf}
...
\authorinfo{Ben Liblit}{Computer Sciences Department \\ University of Wisconsin}{\mailto{liblit@cs.wisc.edu}}
...
\conferenceinfo{PLDI '05}{12--15 June 2005, Chicago, Illinois, USA}
...
domain-specific.  Our algorithm could also be used to identify {\em
early warning} predicates that predict impending failure in actual
use.
