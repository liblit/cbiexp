...
These problems with regularized logistic regression persist across many variations
...
This section summarizes ideas and terminology needed to present our
...
observations of the $< 0$, $\leq 0$, and $\neq 0$ predicates in the
