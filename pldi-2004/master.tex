...
The first bug, discssed briefly in \Autoref{sec:introduction}, is
...
call stack at the point of crash for both bugs is unhelpful (see \Autoref{sec:conclusions}).  We feel confident in saying that without the use of
...
This paragraph shows how to cross reference subtables within
\autoref{tab:sorts}.  See also \autoref{tab:sorts-failure},
\autoref{tab:sorts-increase}, and \autoref{tab:sorts-harmonic}.

\input{views/table}

This paragraph shows how to cross reference subtables within
\autoref{tab:views}.  See also \autoref{tab:views-ccrypt},
\autoref{tab:views-bc}, \autoref{tab:views-exif}, and
\autoref{tab:views-rhythmbox}.
