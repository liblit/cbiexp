...
Let $\bug$ denote a bug (i.e., something causes incorrect behavior in
...
union of all bugs profiles is exactly the
...
\termdef{predictor}) of bug profile $\bugprofile$ if whenever $\report{P} = 1$
