...
\termdef{affinity list} of all predicates ranked by how much $P$
...
To illustrate how statistical debugging is used in practice, we will
...
{\tt exif\_mnote\_data\_canon\_load} as a strong failure predictor.  A
quick inspection of the source code this leads us to construct the
