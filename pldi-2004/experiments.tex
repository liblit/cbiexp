...
to see results equivalent to those for 32,000 runs.
\autoref{tab:numruns} presents the results of this analysis.  The
``All Runs'' column shows the the minimum number of runs needed to
...
sufficient to isolate \exif{} bugs \#1 and \#2.
...
The intuition behind this second metric is that in understanding how
