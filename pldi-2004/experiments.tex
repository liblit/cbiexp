...
\bc 1.06 has a previously reported buffer overrun.  Our results are shown in Table~\ref{tab:views-bc}.
...
Table~\ref{tab:views-exif} shows results for \exif 0.6.9, an open source image processing program.
...
Table~\ref{tab:views-rhythmbox} shows our results for \rhythmbox
