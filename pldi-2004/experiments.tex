...
The results are shown in Table~\ref{tab:views-ccrypt}.
...
The results for \bc\ are shown in Table~\ref{tab:views-bc}, which has a known buffer overrun.
...
Table~\ref{tab:views-exif} shows results for \exif, an open source image processing program.
...
Table~\ref{tab:views-rhythmbox} shows our results for \rhythmbox, an open source jukebox player.
