...
a fast machine.
At \nicefrac{1}{100} sampling, step (1) of our algorithm eliminates about 99\% of
...
\begin{figure*}
  \subfigure[branches, returns, and scalar pairs]{\includegraphics[width=\columnwidth]{predkept3a}\label{fig:predkept-a}}
  \hfill
  \subfigure[branches and returns only]{\includegraphics[width=\columnwidth]{predkept3b}\label{fig:predkept-b}}
