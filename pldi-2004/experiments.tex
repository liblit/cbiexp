...
Notice that less than 100 failing runs must share any given bug as their cause of
failure before the predictor for that bug is reported by our algorithm.
