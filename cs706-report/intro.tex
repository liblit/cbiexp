...
\autoref{sec-quant} presents the results of experiments conducted on a large suite of buggy test programs.  \autoref{sec-sampling} considers the effect of sparse random sampling on complex predicates.  Sparse random sampling is a technique used by CBI to reduce the runtime overhead on the instrumented programs.  \autoref{sec-rw} discusses related work and \autoref{sec-conc} concludes.
