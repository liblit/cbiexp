...
def runDeltaLDA(data, numsamp, randseed):
...
def processMatFile(source, usageTopics, bugTopics):
    """
...
def deltaLDARun(runsinfo, optargs={}):
    ...
    * optargs - dictionary containing 'usageTopics', 'bugTopics', 'numsamp',
    ...
    processedMat = processMatFile(runsinfo, usageTopics, bugTopics)
    deltaLDAResults = runDeltaLDA(processedMat, numsamp, randseed)
...
def main(argv=None):
    ...
    return deltaLDARun(args[0], optargs)
